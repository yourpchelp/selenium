...
public class RuumList {
    ...
    protected final String newRuumButton = "//lobby-list-new-item//button//*[contains(text(),'New')]";
    ...
    protected final String busyState = "//busy-state";
    protected RuumPopoverWindow popover = new RuumPopoverWindow();
    protected final String userProfileButton = "//button[@data-test='ruum-navbar-profile']";
    protected Project project = new Project();
    protected final String templatesButton = "//ruum-navbar//ruum-main-navbar//*[@class='nav-item']//button[contains(text(),'Templates')]";
    protected final String ruumLogo = "//ruum-navbar//ruum-main-navbar//*[@class='navbar-brand']";
    ...
    public RuumListItem getRuumListItemByName(WebDriver driver, String name) {
    	String listItemXPath = ruumListItems + "//*[contains(text(),'" + name + "')]";
    	return new RuumListItem(listItemXPath);
    }
    ...
    public void addNewEmptyProject(WebDriver driver, String ruumTitle) throws Exception {
    	driver.findElement(By.xpath(newRuumButton)).click();
    	driver.findElement(By.xpath(popover.getRuumPopoverOptions() + "//*[text(),'Ruum']")).click();
    	project.setRuumTitle(driver, ruumTitle);
        //  the following click is used for exiting from title field
    	driver.findElement(By.xpath(project.canvasSyncState)).click();
        Thread.sleep(1000);
    ...
    public void leaveRuum(WebDriver driver, String ruumTitle) throws Exception {
        ...
        driver.findElement(By.xpath(popover.getRuumPopoverOptions() + "//*[contains(text(),'Leave')]")).click();
    ...
    public void logout(WebDriver driver) {
        ...
        driver.findElement(By.xpath("//ruum-navbar//ruum-main-navbar//ruum-settings-popover//button" + "//*[contains(text(),'Logout')]")).click();
        driver.findElement(By.xpath(LoginForm.emailInputField)).clear();  // to clean input field
    }
    ...
    public void waitIfBusy(WebDriver driver){
		...
		do {
        	isBusy = CommonUtils.isElementExists(driver, busyState + "//*[contains(@class, 'busy-container')]" + "[//*contains(@class, 'busy')]");
        }
        while (isBusy) ;
    }
    ...
    public void renameRuum(WebDriver driver, String currentTitle, String newTitle) {
        ...
        driver.findElements(By.xpath(listItem.ruumListItemXPath + "[//*contains(@class, 'ruum-lobby-item-more-options')]//button")).get(2).click();
