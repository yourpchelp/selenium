...
public class RuumPopoverWindow {
    ...
    protected final String datePickerSelectedDay = datePickerDays + "//*[contains(@class, 'ruum-datepicker-selected-day')]";
    protected final String datePickerNavigation = datePicker + "//*[contains(@class, 'ruum-datepicker-navigation')]";
    ...
    public void pushButton(WebDriver driver, String buttonCaption) {
    	driver.findElement(By.xpath(ruumPopoverButtons + "[contains(text(),'" + buttonCaption + "')]")).click();
    }
